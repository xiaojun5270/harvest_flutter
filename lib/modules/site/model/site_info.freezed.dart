...
mixin _$SiteInfo {
 ...
 int get id; String get site; String get nickname;@JsonKey(name: 'sort_id') int get sortId; List<String> get tags;@JsonKey(name: 'user_id') String? get userId; String? get username; String? get email; String? get passkey; String? get authkey; String? get cookie;@JsonKey(name: 'local_storage', readValue: _readLocalStorage, fromJson: _localStorageFromJson) String? get localStorage;@JsonKey(name: 'user_agent') String? get userAgent; String? get rss; String? get torrents; bool get available;@JsonKey(name: 'sign_in') bool get signIn;@JsonKey(name: 'get_info') bool get getInfo;@JsonKey(name: 'repeat_torrents') bool get repeatTorrents;@JsonKey(name: 'brush_free') bool get brushFree;@JsonKey(name: 'brush_rss') bool get brushRss;@JsonKey(name: 'package_file') bool get packageFile;@JsonKey(name: 'hr_discern') bool get hrDiscern;@JsonKey(name: 'search_torrents') bool get searchTorrents;@JsonKey(name: 'show_in_dash') bool get showInDash; String? get proxy; Map<String, dynamic> get removeTorrentRules; String? get mirror;@JsonKey(name: 'time_join') String? get timeJoin;@JsonKey(name: 'latest_active') String? get latestActive; int get mail; int get notice;@JsonKey(name: 'sign_info') Map<String, dynamic>? get signInfo;@JsonKey(fromJson: _statusFromJson) Map<String, SiteDailyStatus>? get status;@JsonKey(name: 'updated_at') String? get updatedAt;
...
/// Create a copy of SiteInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? site = null,Object? nickname = null,Object? sortId = null,Object? tags = null,Object? userId = freezed,Object? username = freezed,Object? email = freezed,Object? passkey = freezed,Object? authkey = freezed,Object? cookie = freezed,Object? localStorage = freezed,Object? userAgent = freezed,Object? rss = freezed,Object? torrents = freezed,Object? available = null,Object? signIn = null,Object? getInfo = null,Object? repeatTorrents = null,Object? brushFree = null,Object? brushRss = null,Object? packageFile = null,Object? hrDiscern = null,Object? searchTorrents = null,Object? showInDash = null,Object? proxy = freezed,Object? removeTorrentRules = null,Object? mirror = freezed,Object? timeJoin = freezed,Object? latestActive = freezed,Object? mail = null,Object? notice = null,Object? signInfo = freezed,Object? status = freezed,Object? updatedAt = freezed,}) {
...
as String?,localStorage: freezed == localStorage ? _self.localStorage : localStorage // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String site,  String nickname, @JsonKey(name: 'sort_id')  int sortId,  List<String> tags, @JsonKey(name: 'user_id')  String? userId,  String? username,  String? email,  String? passkey,  String? authkey,  String? cookie, @JsonKey(name: 'local_storage', readValue: _readLocalStorage, fromJson: _localStorageFromJson)  String? localStorage, @JsonKey(name: 'user_agent')  String? userAgent,  String? rss,  String? torrents,  bool available, @JsonKey(name: 'sign_in')  bool signIn, @JsonKey(name: 'get_info')  bool getInfo, @JsonKey(name: 'repeat_torrents')  bool repeatTorrents, @JsonKey(name: 'brush_free')  bool brushFree, @JsonKey(name: 'brush_rss')  bool brushRss, @JsonKey(name: 'package_file')  bool packageFile, @JsonKey(name: 'hr_discern')  bool hrDiscern, @JsonKey(name: 'search_torrents')  bool searchTorrents, @JsonKey(name: 'show_in_dash')  bool showInDash,  String? proxy,  Map<String, dynamic> removeTorrentRules,  String? mirror, @JsonKey(name: 'time_join')  String? timeJoin, @JsonKey(name: 'latest_active')  String? latestActive,  int mail,  int notice, @JsonKey(name: 'sign_info')  Map<String, dynamic>? signInfo, @JsonKey(fromJson: _statusFromJson)  Map<String, SiteDailyStatus>? status, @JsonKey(name: 'updated_at')  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SiteInfo() when $default != null:
return $default(_that.id,_that.site,_that.nickname,_that.sortId,_that.tags,_that.userId,_that.username,_that.email,_that.passkey,_that.authkey,_that.cookie,_that.localStorage,_that.userAgent,_that.rss,_that.torrents,_that.available,_that.signIn,_that.getInfo,_that.repeatTorrents,_that.brushFree,_that.brushRss,_that.packageFile,_that.hrDiscern,_that.searchTorrents,_that.showInDash,_that.proxy,_that.removeTorrentRules,_that.mirror,_that.timeJoin,_that.latestActive,_that.mail,_that.notice,_that.signInfo,_that.status,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String site,  String nickname, @JsonKey(name: 'sort_id')  int sortId,  List<String> tags, @JsonKey(name: 'user_id')  String? userId,  String? username,  String? email,  String? passkey,  String? authkey,  String? cookie, @JsonKey(name: 'local_storage', readValue: _readLocalStorage, fromJson: _localStorageFromJson)  String? localStorage, @JsonKey(name: 'user_agent')  String? userAgent,  String? rss,  String? torrents,  bool available, @JsonKey(name: 'sign_in')  bool signIn, @JsonKey(name: 'get_info')  bool getInfo, @JsonKey(name: 'repeat_torrents')  bool repeatTorrents, @JsonKey(name: 'brush_free')  bool brushFree, @JsonKey(name: 'brush_rss')  bool brushRss, @JsonKey(name: 'package_file')  bool packageFile, @JsonKey(name: 'hr_discern')  bool hrDiscern, @JsonKey(name: 'search_torrents')  bool searchTorrents, @JsonKey(name: 'show_in_dash')  bool showInDash,  String? proxy,  Map<String, dynamic> removeTorrentRules,  String? mirror, @JsonKey(name: 'time_join')  String? timeJoin, @JsonKey(name: 'latest_active')  String? latestActive,  int mail,  int notice, @JsonKey(name: 'sign_info')  Map<String, dynamic>? signInfo, @JsonKey(fromJson: _statusFromJson)  Map<String, SiteDailyStatus>? status, @JsonKey(name: 'updated_at')  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _SiteInfo():
return $default(_that.id,_that.site,_that.nickname,_that.sortId,_that.tags,_that.userId,_that.username,_that.email,_that.passkey,_that.authkey,_that.cookie,_that.localStorage,_that.userAgent,_that.rss,_that.torrents,_that.available,_that.signIn,_that.getInfo,_that.repeatTorrents,_that.brushFree,_that.brushRss,_that.packageFile,_that.hrDiscern,_that.searchTorrents,_that.showInDash,_that.proxy,_that.removeTorrentRules,_that.mirror,_that.timeJoin,_that.latestActive,_that.mail,_that.notice,_that.signInfo,_that.status,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String site,  String nickname, @JsonKey(name: 'sort_id')  int sortId,  List<String> tags, @JsonKey(name: 'user_id')  String? userId,  String? username,  String? email,  String? passkey,  String? authkey,  String? cookie, @JsonKey(name: 'local_storage', readValue: _readLocalStorage, fromJson: _localStorageFromJson)  String? localStorage, @JsonKey(name: 'user_agent')  String? userAgent,  String? rss,  String? torrents,  bool available, @JsonKey(name: 'sign_in')  bool signIn, @JsonKey(name: 'get_info')  bool getInfo, @JsonKey(name: 'repeat_torrents')  bool repeatTorrents, @JsonKey(name: 'brush_free')  bool brushFree, @JsonKey(name: 'brush_rss')  bool brushRss, @JsonKey(name: 'package_file')  bool packageFile, @JsonKey(name: 'hr_discern')  bool hrDiscern, @JsonKey(name: 'search_torrents')  bool searchTorrents, @JsonKey(name: 'show_in_dash')  bool showInDash,  String? proxy,  Map<String, dynamic> removeTorrentRules,  String? mirror, @JsonKey(name: 'time_join')  String? timeJoin, @JsonKey(name: 'latest_active')  String? latestActive,  int mail,  int notice, @JsonKey(name: 'sign_info')  Map<String, dynamic>? signInfo, @JsonKey(fromJson: _statusFromJson)  Map<String, SiteDailyStatus>? status, @JsonKey(name: 'updated_at')  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _SiteInfo() when $default != null:
return $default(_that.id,_that.site,_that.nickname,_that.sortId,_that.tags,_that.userId,_that.username,_that.email,_that.passkey,_that.authkey,_that.cookie,_that.localStorage,_that.userAgent,_that.rss,_that.torrents,_that.available,_that.signIn,_that.getInfo,_that.repeatTorrents,_that.brushFree,_that.brushRss,_that.packageFile,_that.hrDiscern,_that.searchTorrents,_that.showInDash,_that.proxy,_that.removeTorrentRules,_that.mirror,_that.timeJoin,_that.latestActive,_that.mail,_that.notice,_that.signInfo,_that.status,_that.updatedAt);case _:
  return null;
...
class _SiteInfo extends SiteInfo {
  const _SiteInfo({this.id = 0, this.site = '', this.nickname = '', @JsonKey(name: 'sort_id') this.sortId = 0, final  List<String> tags = const [], @JsonKey(name: 'user_id') this.userId, this.username, this.email, this.passkey, this.authkey, this.cookie, @JsonKey(name: 'local_storage', readValue: _readLocalStorage, fromJson: _localStorageFromJson) this.localStorage, @JsonKey(name: 'user_agent') this.userAgent, this.rss, this.torrents, this.available = false, @JsonKey(name: 'sign_in') this.signIn = false, @JsonKey(name: 'get_info') this.getInfo = false, @JsonKey(name: 'repeat_torrents') this.repeatTorrents = false, @JsonKey(name: 'brush_free') this.brushFree = false, @JsonKey(name: 'brush_rss') this.brushRss = false, @JsonKey(name: 'package_file') this.packageFile = false, @JsonKey(name: 'hr_discern') this.hrDiscern = false, @JsonKey(name: 'search_torrents') this.searchTorrents = false, @JsonKey(name: 'show_in_dash') this.showInDash = true, this.proxy, final  Map<String, dynamic> removeTorrentRules = const {}, this.mirror, @JsonKey(name: 'time_join') this.timeJoin, @JsonKey(name: 'latest_active') this.latestActive, this.mail = 0, this.notice = 0, @JsonKey(name: 'sign_info') final  Map<String, dynamic>? signInfo, @JsonKey(fromJson: _statusFromJson) final  Map<String, SiteDailyStatus>? status, @JsonKey(name: 'updated_at') this.updatedAt}): _tags = tags,_removeTorrentRules = removeTorrentRules,_signInfo = signInfo,_status = status,super._();
...
@override@JsonKey(name: 'local_storage', readValue: _readLocalStorage, fromJson: _localStorageFromJson) final  String? localStorage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,site,nickname,sortId,const DeepCollectionEquality().hash(_tags),userId,username,email,passkey,authkey,cookie,localStorage,userAgent,rss,torrents,available,signIn,getInfo,repeatTorrents,brushFree,brushRss,packageFile,hrDiscern,searchTorrents,showInDash,proxy,const DeepCollectionEquality().hash(_removeTorrentRules),mirror,timeJoin,latestActive,mail,notice,const DeepCollectionEquality().hash(_signInfo),const DeepCollectionEquality().hash(_status),updatedAt]);
